  ...
  Future<http.StreamedResponse> send(http.BaseRequest request) async {
    ...
    if (RequestLogger.enabled) {
      ...
      if (bodyBytes.isNotEmpty) {
        ...
        RequestLogger.logLine(
          '[REQ $reqId] body=${RequestLogger.escape(logged)}',
        );
      }
    }
    try {
      ...
      void armIdleTimer() {
        ...
        idleTimer = Timer(_receiveTimeout, () {
          ...
          controller.addError(
            TimeoutException(
              'No response data received within ${_receiveTimeout.inSeconds} seconds',
            ),
          );
          controller.close();
        });
          ...
          (chunk) {
            ...
            if (RequestLogger.enabled && RequestLogger.saveOutput) {
              ...
              if (s.isNotEmpty) {
                ...
                RequestLogger.logLine(
                  '[RES $reqId] chunk=${RequestLogger.escape(logged)}',
                );
              }
            }
          },
